...
spikein_data_all <- fread('2019_synfrag0.01_spikeincellline_dedup_lowconc.csv')
...
spikein_data <- load('dedup.rda')
spikein_data_melt <- melt(spikein_data, measure.vars = c('sample1','sample2'))
colnames(spikein_data_melt) <- c("frag_grp", "id", "read")
